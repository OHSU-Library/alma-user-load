CREATE DEFINER=`libadm`@`10.%` PROCEDURE `SIS_XML_Create_Outfile_UPDATE_TEST`(IN filename VARCHAR(256), IN update_date VARCHAR(30))
BEGIN
...
SET @sql =
	CONCAT(
        ...
        WHERE primary_id = 'peterson@ohsu.edu'
